...
public class LocalRosters {
    ...
    public static final URI CONODE_1 = buildURI("tcp://localhost:7002");
    public static final URI CONODE_2 = buildURI("tcp://localhost:7004");
    public static final URI CONODE_3 = buildURI("tcp://localhost:7006");
    public static final URI CONODE_4 = buildURI("tcp://localhost:7008");
