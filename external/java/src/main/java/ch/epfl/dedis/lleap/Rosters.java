...
public class Rosters {
    ...
    public static byte[] DEDISID = DatatypeConverter.parseHexBinary("77d81678c3b27595d75fed7edf079b1f8804da7d6ecb95cb7b6b7d83954d3abd");

    public static String privateKeyStr = "30820941020100300D06092A864886F70D01010105000482092B308209270201000282020100" +
    ...
    public static PrivateKey getPrivate() {
        try {
            ...
            return kf.generatePrivate(new PKCS8EncodedKeySpec(DatatypeConverter.parseHexBinary(Rosters.privateKeyStr)));
